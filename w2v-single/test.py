...
le = len('/media/data1/ananya/TAMIL-SLT-extension/large/test/')
n_epoch = 100
#num_classes = 4
...
files_list=[]
folders = glob.glob('/media/data1/ananya/TAMIL-SLT-extension/large/test/*')
print("Folder=", folders)
for folder in folders:
    for f in glob.glob(folder+'/*.pt'):
        files_list.append(f)
print('Total Training files: ',len(files_list))
txtfl = open('/media/data1/ananya/TAMIL-SLT-extension/large/test.txt', 'w')
...
for e in range(10,n_epoch): # repeat for n_epoch
    i = 0
    cost = 0.0
  ...
  #Counting the number of files
        ...
        full_preds.append(int(predictions))
        full_gts.append(int(Y1))
